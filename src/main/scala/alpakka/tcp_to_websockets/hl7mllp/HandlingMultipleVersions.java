...
public class HandlingMultipleVersions {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 *  - deprecate old fields and segments and groups
		 *  - but they never remove them entirely
		 * They will also rename fields and groups, but this has
		...
		// Message type: Observation Result (ORU^R01)
		// https://corepointhealth.com/resource-center/hl7-resources/hl7-oru-message/
